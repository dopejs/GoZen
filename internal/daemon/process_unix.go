...
// IsRunning checks if the legacy web daemon process is still alive.
...
// StopDaemon sends SIGTERM to the legacy web daemon process.
...
// --- zend daemon process management ---
