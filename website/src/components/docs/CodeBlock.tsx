...
export function CodeBlock({
  ...
  return (
    <div className="group relative max-w-full no-scrollbar overflow-x-auto rounded-lg border border-border" style={{ backgroundColor: '#0f1117', WebkitOverflowScrolling: 'touch' }}>
      {showCopy && (
        <button
          onClick={handleCopy}
